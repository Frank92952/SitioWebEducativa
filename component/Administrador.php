...
<header class="header">
   ...
   <nav class="navbar">
    ...
    <form action="../conexion/Mensaje.php" method="POST">
    <center><h1>Mensaje a la Institución</h1></center>
    <label for="titulo" class="form-label">Título:</label>
    <input type="text" id="titulo" name="titulo" class="form-input" required placeholder="Ingrese el Título">
    <label for="contenido" class="form-label">Contenido:</label>
    <textarea type="text" id="contenido" name="contenido" class="form-textarea" placeholder="Ingrese el Mensaje" required></textarea>
