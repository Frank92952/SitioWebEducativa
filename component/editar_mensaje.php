...
// Obtener el ID del mensaje a editar
$id = $_GET['id'];

// Obtener los datos del mensaje de la base de datos
...
if ($resultado->num_rows > 0) {
    ...
    echo "<form action='actualizar_mensaje.php' method='POST'>
            <center><h2>Editar mensaje</h2></center>
            <input type='hidden' name='id' value='$id'>
            <label  class='form-label' for='titulo'>Titulo:</label>
            <input type='text' class='form-input' id='titulo' name='titulo' value='$nombre' required><br><br>
            <label class='form-label' for='contenido'>Contenido:</label>
            <textarea id='contenido' class='form-textarea' name='contenido' required>$mensaje</textarea><br><br>
