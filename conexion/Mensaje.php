...
<link rel="stylesheet" href="../component/estylos1.css" />
...
<header class="header">
   ...
   <nav class="navbar">
      ...
      <a href="../component/Administrador.php">Mensaje</a>
      <a href="../component/VerMensaje.php">Administrador</a>
   </nav>
...
$sql = "INSERT INTO mensaje (titulo, contenido) VALUES ('$titulo', '$contenido')";
if ($conexion->query($sql) === TRUE) {
    echo "Mensaje ingresado exitosamente";
} else {
    echo "Error al ingresar el mensaje: " . $conexion->error;
}
